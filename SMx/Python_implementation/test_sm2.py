...
def test_sm2():
    ...
    print(bytes.hex(enc_data))
    print(len(bytes.hex(enc_data)))
...
def read_quant():
    main = 'd:\\123\\dillithiumdll\\x64\\Debug\\dillithiumdll.exe'
    os.system(main)
    f = open('PQCsignKAT_Dilithium5.rsp')
    line = f.readline()
    line = f.readline()
    line = f.readline()
    data = []
